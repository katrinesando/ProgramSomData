...
and cExpr (e : expr) (varEnv : varEnv) (funEnv : funEnv) : instr list = 
    ...
    | Prim1(ope, e1) ->
      ...
      @ (match ope with
         ...
         | "car"    -> [CAR]
         | "cdr"    -> [CDR]
         | "createTable" -> [CREATETABLE] // exam opg 3.4
         | "printTable" -> [PRINTTABLE] // 2021 exam opg 3.4
    ...
    | Prim2(ope, e1, e2) ->
      ...
      @ (match ope with
         ...
         | "setcar" -> [SETCAR]
         | "setcdr" -> [SETCDR]
         | "indexTable" -> [INDEXTABLE] //Start - 2021 exam opg 3.4
         | _        -> raise (Failure "unknown primitive 2"))
//Start - 2021 exam opg 3.4 - See also Prim1
    |Prim3(ope, e1,e2,e3) ->
        cExpr e1 varEnv funEnv
      @ cExpr e2 varEnv funEnv
