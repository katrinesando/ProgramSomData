...
type instr =
  ...
  | CREATETABLE                             (* 2021 Exam opg 3   *)
  | UPDATETABLE                             (* 2021 Exam opg 3   *)
  | INDEXTABLE                             (* 2021 Exam opg 3   *)
  | PRINTTABLE                             (* 2021 Exam opg 3   *)
...
let makelabenv (addr, labenv) instr = 
    ...
    | CREATETABLE         -> (addr+1, labenv)  (* 2021 Exam opg 3   *)
    | UPDATETABLE         -> (addr+1, labenv)       (* 2021 Exam opg 3   *)
    | INDEXTABLE          -> (addr+1, labenv)       (* 2021 Exam opg 3   *)
    | PRINTTABLE          -> (addr+1, labenv)       (* 2021 Exam opg 3   *)
